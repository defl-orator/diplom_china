...
if df is not None:
    # 1. Aggregate humanitarian performance indexes
    df['civ_activity'] = (df['civ_02_healthcare_ct'] + 
                          df['civ_06_ci_ct'] + 
                          df['civ_05_judicial_engagement_ct'])

    # 2. Extract comparative yearly means
    ...
    ax.set_xlabel('Average annual humanitarian events (health + CIs + judicial)', fontweight='bold', fontsize=12)
    ...
    filename = f'Humanitarian_Dumbbell_{LANG}.jpg'
